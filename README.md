...
- We have divided the locations into 5 categories where the locations in each category have a similar density of 65+ aged population.  
- Distribution of population density over 65+ aged people: 

# Input dataset:
- We have a total of 22 input features in the dataset.
...
# Methodology:
- To train the input dataset, an Artificial Neural Network is used for regression.
- GridSearch technique is used to choose the hyperparameters, activation function, solver, and number and size of hidden layers. 
- Four hidden layers are used to train the model with the sizes of 22, 20, 10, and 5. 
